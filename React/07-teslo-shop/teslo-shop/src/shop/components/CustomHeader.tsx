...
export const CustomHeader = () => {
    ...
    const { authStatus, isAdmin, logout } = useAuthStore() //consumir el gestor de estado (zustand)

    const { gender } = useParams() //Utilizamos useParams
    console.log(gender)
