...
export const ProductsGrid = ({ products }: Props) => {
    const [searchParams, setSearchParams] = useSearchParams() //desestructuramos el searchParams
    const [showFilters, setShowFilters] = useState(false)
    const viewMode = searchParams.get("viewMode") ?? 'grid'
    //función handle de view mode
    const handleViewMode = (mode: 'grid' | 'list') => {
        searchParams.set("viewMode", mode) //seteamos el searchparams
