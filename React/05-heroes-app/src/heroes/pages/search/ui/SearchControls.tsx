...
import { useSearchParams } from "react-router"  // ✅ sin useParams

export const SearchControls = () => {
    const [searchParams, setSearchParams] = useSearchParams()
    const inputRef = useRef<HTMLInputElement>(null)

    // ✅ Variables conectadas al JSX
        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                <div className="relative flex-1">
                    ...
                    <Input
                        ref={inputRef}
                        value={currentName}       // ✅ ref conectado
                        onKeyDown={handleKeyDown}   // ✅ evento conectado
            ...
            <div className="bg-white rounded-lg p-6 mb-8 shadow-sm border">
                ...
                <div className="mt-4">
                    ...
                    <input
                        ...
                        onChange={(e) => setQueryParams('strength', e.target.value)}
